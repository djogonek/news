		...
		function postDiv($pict,cath,title,cont,auth,date)//creating new post
				...
				if (count%2==0)
					{
						...
						padCenterDiv.style.paddingLeft="2.2%";
						padCenterDiv.style.paddingRight="2.2%";
			...
			function send(numbPost)//requesting data from server
				{
					$.ajax
						({
							url: 'backend/srv.php',
	...
	function timer(interval)
			{
				timerUpdate=window.setInterval("send(3);", interval);
			};
	timer(30000);		
